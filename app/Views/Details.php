    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="d-flex justify-content-end" style="margin-top: 20px;">
          <button id="likeButton" type="button" data-id-movie="<?= $status['id'] ?>" class="controls controls_button">
            ...
            <p id="movie-likes"><?= $status['likes']; ?></p>
          </button>
          <button id="dislikeButton" type="button" data-id-movie="<?= $status['id'] ?>" class="controls controls_button">
            ...
            <p id="movie-dislikes"><?= $status['dislikes'] ?></p>
          </button>
