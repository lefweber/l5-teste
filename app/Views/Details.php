    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="d-flex justify-content-end" style="margin-top: 20px;">
          <button id="likeButton" type="button" data-id-movie="<?= $idMovie ?>" class="controls controls_button">
          ...
          <button id="dislikeButton" type="button" data-id-movie="<?= $idMovie ?>" class="controls controls_button">
